...
<body id="ourbody"  style="background-color: black;" onload="check_new_version()">
<div id="links" style="display: none;"></div>


<div class="mt-2 d-flex justify-content-center" id="t">
    <textarea class="form-control w-50 m-3" placeholder="result ..." id="result" rows="15" style="background-color: blueviolet; background-image:url(back.png.png); background-size:cover;"></textarea>
</div>
<div class="mt-2 d-flex justify-content-center">
    ...
    <button class="btn  m-2" id="btn-clear" onclick="logs()" ondblclick="clogs()">LOGS</button>
